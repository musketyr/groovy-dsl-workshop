...
Only `Diagram01Spec` passes at the beginning. Your task is to make the necessary changes to make the rest of the tests
passing. Some of them will required uncommenting pieces of code inside the tests but the test will tell you itself
...
.Note.java
----
include::../step-00/src/main/java/cz/orany/yuml/model/Note.java[]
----
...
.Relationship.java
----
include::../step-00/src/main/java/cz/orany/yuml/model/Relationship.java[]
----

[source,java,indent=0,options="nowrap"]
.RelationshipType.java
----
include::../step-00/src/main/java/cz/orany/yuml/model/RelationshipType.java[]
----
...
.Type.java
----
include::../step-00/src/main/java/cz/orany/yuml/model/Type.java[]
----
